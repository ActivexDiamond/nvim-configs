...
--]]
	...
	--Header
	RenderMarkdownH1 = {fg = "#00ff00"},
	RenderMarkdownH1Bg = {bg = "#663c3c"},
...
local mix = function(color1, color2)
	...
	local r1, g1, b1 = tonumber("0x" .. string.sub(color1, 1, 2)), tonumber("0x" .. string.sub(color1, 3, 4)),
		tonumber("0x" .. string.sub(color1, 5, 6))
	local r2, g2, b2 = tonumber("0x" .. string.sub(color2, 1, 2)), tonumber("0x" .. string.sub(color2, 3, 4)),
