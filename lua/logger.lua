...
M.log = {
	dbg   = function(val, opts) preprocess(val,
			vim.tbl_deep_extend('force', opts or {}, { log_level = vim.log.levels.DEBUG })) end,
	err   = function(val, opts) preprocess(val,
			vim.tbl_deep_extend('force', opts or {}, { log_level = vim.log.levels.ERROR })) end,
	info  = function(val, opts) preprocess(val,
			vim.tbl_deep_extend('force', opts or {}, { log_level = vim.log.levels.INFO })) end,
	trace = function(val, opts) preprocess(val,
			vim.tbl_deep_extend('force', opts or {}, { log_level = vim.log.levels.TRACE })) end,
	warn  = function(val, opts) preprocess(val,
			vim.tbl_deep_extend('force', opts or {}, { log_level = vim.log.levels.WARN })) end,
	off   = function(val, opts) preprocess(val,
			vim.tbl_deep_extend('force', opts or {}, { log_level = vim.log.levels.OFF })) end,
}
