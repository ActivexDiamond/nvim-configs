...
vim.o.foldtext       =
"substitute(getline(v:foldstart),'\t',repeat(' ',&tabstop),'g').' ... '.trim(getline(v:foldend))"                        -- Sexy minimal folds
...
--TODO: Actually finish setting up gf to work with terminal errors and what not.
